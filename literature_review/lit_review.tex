...
\end{figure}
\todo{Modify figure to remove dashed boxes}
...
\paragraph{\gls{dna}}  \todo{Need to actually write this bit...}
...
%	\label{fig:taxonomy_measures}
%\end{figure}
\todo{Include taxonomy/summary diagram similar to this figure}
